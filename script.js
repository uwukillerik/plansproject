document.addEventListener('DOMContentLoaded', function() {
    const projects = [
        {
            title: "LightFlash",
            description: "Инновационная флэш-криптовалюта с мгновенными транзакциями",
            image: `<svg viewBox="0 0 24 24"><path d="M5.5 12H10V6.5H13.5V12H18L12 17.5L5.5 12Z"/></svg>`,
            details: "Полностью анонимная криптовалюта с технологией мгновенных транзакций. Поддержка смарт-контрактов и децентрализованных приложений."
        },
        {
            ...
            details: "AI-бот для знакомств с верификацией пользователей, системой рейтингов и интеллектуальным подбором партнеров на основе психологических тестов."
        },
        {
            ...
            details: "Комплексный бот для монетизации Telegram-каналов с системой подписок, платного контента и реферальной программой."
        },
        {
            title: "Крипто бот тапалка",
            description: "Торговый бот для криптобирж с алгоритмами следования",
            ...
            details: "Автоматизированная торговая система с поддержкой 20+ криптобирж, техническим анализом и риск-менеджментом."
        },
        {
            title: "Казино бот",
            description: "Виртуальное казино с поддержкой криптовалют",
            ...
            details: "Полнофункциональное крипто-казино с играми: рулетка, блекджек, слоты, покер. Система бонусов и турниров."
        },
        {
            title: "Бот пробив/снос",
            description: "Инструмент для анализа открытых данных",
        ...
        {
            title: "Бот анонимок",
            description: "Анонимный мессенджер с шифрованием",
            ...
            details: "Конфиденциальный мессенджер с end-to-end шифрованием, автоматическим удалением сообщений и защитой от скриншотов."
        },
        {
            title: "Игробот",
        ...
        {
            title: "Gorilla бот",
            description: "Аналог Gorilla для ВК с расширенными функциями",
        ...
        },
        {
            ...
            details: "Децентрализованная площадка для торговли с системой гаранта, рейтингами продавцов и поддержкой криптоплатежей."
        }
    ];
